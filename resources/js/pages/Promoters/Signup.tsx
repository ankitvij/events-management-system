                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div className="rounded-xl border-2 border-[#f97316] bg-[#fff7ed] p-4 shadow-sm">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <div className="text-sm font-semibold text-[#9a3412]">Promoter signup</div>
                                <div className="text-xs text-[#9a3412]">Enter your details and submit your profile for approval.</div>
                            </div>

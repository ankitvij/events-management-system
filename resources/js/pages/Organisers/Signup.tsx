...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Signup', href: '/organisers/signup' },
];

export default function OrganisersSignup() {
    ...
    function submit(e: FormEvent) {
        e.preventDefault();
        form.post('/organisers/signup');
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Organiser Signup" />
                ...
                {page.props?.flash?.success && (
                    <div className="mb-4 rounded-md border border-green-200 bg-green-50 p-3 text-sm text-green-800">
                        ...
                        <ul className="mt-2 list-disc pl-5">
                            <li>Your organiser profile is pending approval.</li>
                            <li>You can sign in once your profile is activated.</li>
                        </ul>
                    </div>
                )}

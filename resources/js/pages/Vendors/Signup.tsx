...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Signup', href: '/vendors/signup' },
];

export default function VendorsSignup({ types }: Props) {
    ...
    function submit(e: FormEvent) {
        e.preventDefault();
        form.post('/vendors/signup');
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Vendor Signup" />
            ...
            <div className="p-4">
                ...
                {page.props?.flash?.success && (
                    <div className="mb-4 rounded-md border border-green-200 bg-green-50 p-3 text-sm text-green-800">
                        ...
                        <ul className="mt-2 list-disc pl-5">
                            <li>Your request is now in review.</li>
                            <li>We will activate your profile after approval.</li>
                            <li>You can sign in with your email once activation is complete.</li>
                        </ul>
                    </div>
                )}
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="type" className="block text-sm font-medium">Type <span className="text-red-600">*</span></label>
                        <select id="type" name="type" className="input" required value={form.data.type} onChange={e => form.setData('type', e.target.value)}>
                            {types.map((t) => (
                    ...
                    <div>
                        ...
                        <input id="city" name="city" value={form.data.city} onChange={e => form.setData('city', e.target.value)} className="input" />

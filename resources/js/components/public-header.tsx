        ...
        <>
            <header className="sticky top-0 z-50 border-b-0 max-[999px]:-mx-[5px] min-[1000px]:bg-[#18181b]">
                <div className="w-full px-0 py-0 min-[1000px]:px-3 min-[1000px]:py-2">
                    ...
                    <div className="hidden w-full items-center gap-2 px-0 py-0 min-[1000px]:flex">
                        <Link href="/" className="inline-flex items-center pl-0">
                            <AppLogoIcon alt="ChancePass" className="h-14 w-auto" />
                        </Link>
